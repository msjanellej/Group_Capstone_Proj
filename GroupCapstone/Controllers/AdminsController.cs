...
namespace GroupCapstone.Controllers
{
    ...
    public class AdminsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,IdentityUserId")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,IdentityUserId")] Admin admin)
        {
            if (id != admin.Id)
            {
                return NotFound();
